...
public class Volcano extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        return elevation == volcano.elevation && isActive == volcano.isActive && Objects.equals(name, volcano.name) && volcanoType == volcano.volcanoType && Objects.equals(lastEruption, volcano.lastEruption) && Objects.equals(country, volcano.country) && Objects.equals(volcanologists, volcano.volcanologists);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, elevation, volcanoType, isActive, lastEruption, country, volcanologists);
    }
}
